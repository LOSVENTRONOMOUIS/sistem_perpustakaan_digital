    ...
    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 md:p-10">
        ...
        <form action="buku.php?action=store" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="number" name="stok" class="w-full md:w-1/3 px-4 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-slate-700" placeholder="0" required>
            </div>
