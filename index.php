...
$totalBuku = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM buku"));
$totalAnggota = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users WHERE role='anggota'"));
$totalPeminjaman = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM peminjaman WHERE status='dipinjam'"));
...
<?php while($a = mysqli_fetch_array($aktivitas)){ ?>
...
<a href="tambah_buku.php" class="btn btn-primary rounded-4">
Tambah Buku
</a>
</div>
...
<?php
$buku = mysqli_query($conn, "SELECT * FROM buku LIMIT 5");
...
<a href="buku.php" class="btn btn-outline-primary rounded-4 p-3">
📚 Kelola Buku
</a>

<a href="anggota.php" class="btn btn-outline-success rounded-4 p-3">
👥 Data Anggota
</a>

<a href="peminjaman.php" class="btn btn-outline-warning rounded-4 p-3">
📖 Peminjaman Buku
</a>

<a href="laporan.php" class="btn btn-outline-dark rounded-4 p-3">
📊 Laporan
</a>
</div>
